...
<%
String path = request.getContextPath();//获取web的根路径
...
<html>
 ...
 <% 
  ...
  // stat.execute("insert into student(id,name,age,gender,major)values("+id+",'"+name+"',"+age+",'"+gender+"','"+major+"')"); 
    rs=stat.executeQuery("select * from t_blah");
...
//    out.print("<td>"+rs.getString("gender")+"</td>");
    ...
    %>
    <td>
    <a href="deletefold.jsp?id=<%=rs.getInt("id") %>">删除</a>
    </td>
...
<h3><a href=home.jsp>退出登录</a></h3> 
  <h3><a href="manager.jsp">修改用户信息</a></h3>
<br>
