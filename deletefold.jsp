...
<html>
  ...
  <body background ="images/ccc.jpg">
    ...
    String id=request.getParameter("id"); //获取id字符串,如果没有提前指定，则会按照服务器端默认的“iso-8859-1”来进行编码；
...
//     stat=conn.createStatement(); 
    ...
    stmt = conn.prepareStatement("delete from t_blah where id= "+id+"");  //执行sql删除语句
...
//     }
    ...
    <br>
 <br>
     <center> <a href=home.jsp>退出登录</a> <a href=fold1.jsp>返回信息查询页面</a></center>
